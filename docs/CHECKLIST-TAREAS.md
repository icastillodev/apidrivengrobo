...
- [x] **En la lista (tabla) del gestor de usuarios, mostrar cuántos protocolos tiene a su cargo cada usuario.**  
  ...
  **Hecho:** UserModel añade `ProtocolCount`; tabla usuarios con columna ordenable; i18n `col_protocolos` en ES, EN, PT.
...
- [ ] **Eliminación total de usuario (con protocolos y formularios asociados).**  
...
- [ ] **Insumos y Reactivos – misma lógica de externos/internos que en Animales.**  
