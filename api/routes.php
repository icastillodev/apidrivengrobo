...
$router->get('/user/protocols/network-status', 'ControllerusuarioTodosProtocolos@getNetworkStatus');
...
$router->post('/protocols/delete-manual', 'ProtocolController@deleteManual');
$router->post('/protocols/manual-attachments/delete', 'ProtocolController@deleteManualAttachment');
$router->post('/protocols/reject-request', 'ProtocolController@rejectApprovedRequest');
