...
// Catálogo Maestro: Rutas ahora relativas a la carpeta "paginas"
const MENU_TEMPLATES = {
   ...
   // 301: { label: 'Historial', svg: `<svg viewBox="0 0 24 24"><path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg>`, path: 'superadmin/historial.html' },
    ...
    501: { 
        ...
        isDropdown: true,
        children: [
            { label: 'Configurar', path: 'admin/perfil' }, // Ojo, esta ruta es admin/, verifícalo en tu carpeta
...
// NUEVA FUNCIÓN MÁS SEGURA PARA LAS RUTAS
function getCorrectPath(rawPath) {
    ...
    const basePath = isLocalhost ? '/URBE-API-DRIVEN/front/paginas/' : '/paginas/';

    // Solo retornamos la base unida al archivo final (ej: /paginas/superadmin/instituciones.html)
