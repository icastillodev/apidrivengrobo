...
const MENU_TEMPLATES = {
    ...
    401: { label: 'BITACORA', svg: `<svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m-1 11h-5v5h-2v-5H6v-2h5V7h2v5h5v2z"/></svg>`, path: 'superadmin/bitacora.html' },
