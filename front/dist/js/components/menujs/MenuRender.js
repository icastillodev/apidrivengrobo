        ...
        modal.innerHTML = `
            <div class="gecko-omni-box">
                <div class="gecko-omni-header">
                    ...
                    <button type="button" id="gecko-omni-voice-train-btn" class="gecko-omni-voice-train-btn" data-i18n-aria-label="menu.voice_train_aria" data-i18n-title="menu.voice_train_aria" title="">
...
function buildControlsHTML(layout) {
    ...
    return `<li class="${isSide ? 'd-flex justify-content-center align-items-center gap-2 w-100 flex-row flex-wrap m-0 p-0' : 'nav-item d-flex align-items-center ms-2 ps-2 border-start border-secondary-subtle'}">
        ...
        <div class="position-relative dropdown-container-lang ${!isSide ? 'mx-1' : ''}">
            ...
            <ul class="dropdown-menu-lang hidden shadow p-2 border list-unstyled" style="position: absolute; min-width: 140px; z-index: 9999; touch-action: manipulation; ${isSide ? 'bottom: 110%; left: 50%; transform: translateX(-50%); margin-bottom: 10px;' : 'top: 120%; right: 0;'}">
                <li><button type="button" class="gecko-lang-pick d-flex align-items-center w-100 px-2 py-2 text-start text-body small border-0 bg-transparent rounded mb-1 hover-bg-light" data-gecko-lang="es" style="touch-action:manipulation;-webkit-tap-highlight-color:transparent;cursor:pointer;"><img src="https://flagcdn.com/w40/es.png" alt="" width="20" draggable="false" class="me-2 shadow-sm flex-shrink-0" style="pointer-events:none;user-select:none;"> Español</button></li>
                <li><button type="button" class="gecko-lang-pick d-flex align-items-center w-100 px-2 py-2 text-start text-body small border-0 bg-transparent rounded mb-1 hover-bg-light" data-gecko-lang="en" style="touch-action:manipulation;-webkit-tap-highlight-color:transparent;cursor:pointer;"><img src="https://flagcdn.com/w40/us.png" alt="" width="20" draggable="false" class="me-2 shadow-sm flex-shrink-0" style="pointer-events:none;user-select:none;"> English</button></li>
                <li><button type="button" class="gecko-lang-pick d-flex align-items-center w-100 px-2 py-2 text-start text-body small border-0 bg-transparent rounded hover-bg-light" data-gecko-lang="pt" style="touch-action:manipulation;-webkit-tap-highlight-color:transparent;cursor:pointer;"><img src="https://flagcdn.com/w40/br.png" alt="" width="20" draggable="false" class="me-2 shadow-sm flex-shrink-0" style="pointer-events:none;user-select:none;"> Português</button></li>
            </ul>
        </div>
