import { pathVisibleForModules } from '../../modulesAccess.js';
...
export function getMenuTemplates(roleId = 0) {
    ...
    const children55 = inv55All.filter((ch) => pathVisibleForModules(ch.path, roleId));
    ...
    ].filter((item) => roleId !== 3 || item.path !== 'panel/soporte');
