...
export const CHAPTERS = {
  ...
  panel__dashboard: {
    ...
    blocks: [
      ...
      },
      {
        ...
        html: '<p>En módulos como <strong>Mis formularios</strong> o <strong>Centro de solicitudes</strong> verá la barra fija con <strong>Ver documento de ayuda</strong> y, si aplica, <strong>Tutorial interactivo</strong>.</p><figure class="manual-cap-figure my-3 border rounded overflow-hidden"><img src="../../dist/img/capacitacion/panel-barra-ayuda-inferior.svg" width="640" height="120" alt="Esquema: franja verde fija en el borde inferior de la ventana con accesos a ayuda." class="img-fluid d-block w-100" style="max-height:140px;object-fit:contain" loading="lazy" decoding="async" /><figcaption class="small text-body-secondary px-3 py-2 border-top">Esquema orientativo de la barra inferior; sin datos de usuario ni captura de pantalla real.</figcaption></figure>',
      },
      {
        id: 'red',
        cat: 'links',
    ...
    blocks: [
      {
        ...
        html: '<p class="mb-0">Administra <strong>quién puede entrar</strong> a GROBO, con qué <strong>rol</strong>, en qué <strong>departamento</strong> figura y cómo se relaciona con <strong>protocolos</strong> y <strong>pedidos</strong>. Los nombres exactos de botones pueden variar una línea según su sede.</p><dl class="manual-glossary mb-0"><dt><i class="bi bi-door-open text-success" aria-hidden="true"></i> Acceso y rol</dt><dd>Define quién puede iniciar sesión en esta sede y con qué nivel de permisos en el menú.</dd><dt><i class="bi bi-building text-success" aria-hidden="true"></i> Departamento o unidad</dt><dd>Indica dónde figura la persona a efectos organizativos y en filtros del listado.</dd><dt><i class="bi bi-link-45deg text-success" aria-hidden="true"></i> Protocolos y pedidos</dt><dd>Resume cómo la cuenta se vincula a trámites y formularios en curso; influye en qué ve y qué puede solicitar.</dd></dl>',
      },
      {
        id: 'toolbar',
        cat: 'toolbar',
  ...
  admin__solicitud_protocolo: {
    ...
    blocks: [
      ...
      },
      {
        ...
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-person-badge text-success" aria-hidden="true"></i> Titular y equipo</dt><dd>Identificación del titular y co-investigadores.</dd><dt><i class="bi bi-heart-pulse text-success" aria-hidden="true"></i> Alcance científico</dt><dd>Especies, procedimientos y fechas alineadas al dictamen o documento oficial.</dd><dt><i class="bi bi-paperclip text-success" aria-hidden="true"></i> Adjuntos</dt><dd>PDF del comité, anexos obligatorios y formato permitido.</dd><dt><i class="bi bi-building text-success" aria-hidden="true"></i> Datos institucionales</dt><dd>Departamento, centro de costos o campos locales según política de la sede.</dd></dl>',
      },
      {
        id: 'estados',
        cat: 'comms',
        ...
        html: '<p>Los nombres exactos de <strong>estado</strong> varían por configuración. Documente internamente qué significa «listo para bioterio» frente a «solo trámite ético».</p><dl class="manual-glossary mb-0"><dt><i class="bi bi-reply text-success" aria-hidden="true"></i> Comentarios al investigador</dt><dd>Use lenguaje claro; suelen ser visibles en su seguimiento.</dd><dt><i class="bi bi-envelope text-success" aria-hidden="true"></i> Correo</dt><dd>Si hay notificación automática, confirme que el usuario tenga email actualizado en su ficha.</dd><dt><i class="bi bi-window-stack text-success" aria-hidden="true"></i> Subsanación</dt><dd>Devolver con motivo concreto evita idas y vueltas innecesarias.</dd></dl>',
      },
    ],
  },
  admin__animales: {
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'droplet-half',
        h: 'Rol de la bandeja de reactivos',
        html: '<p>Gestiona pedidos de <strong>reactivos o material biológico</strong> cuando la sede los separa de insumos generales. Es la contraparte admin de lo que el investigador sigue en <strong>Mis formularios</strong>. Mantenga estados al día y verifique en el detalle <strong>unidad</strong>, <strong>cantidad</strong> y <strong>condiciones de almacenamiento</strong>.</p>',
      },
      {
        id: 'toolbar',
        cat: 'toolbar',
        icon: 'wrench-adjustable',
        h: 'Barra superior',
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-arrow-clockwise text-success" aria-hidden="true"></i> Actualizar</dt><dd>Recarga la lista y estados en curso.</dd><dt><i class="bi bi-file-earmark-excel text-success" aria-hidden="true"></i> Exportar</dt><dd>Lista filtrada para depósito o compras (si su sede lo ofrece).</dd><dt><i class="bi bi-funnel text-success" aria-hidden="true"></i> Filtros avanzados</dt><dd>Pueden agruparse en panel lateral o modal.</dd></dl>',
      },
      {
        id: 'filters',
        cat: 'filters',
        icon: 'funnel',
        h: 'Filtros típicos',
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-hash text-success" aria-hidden="true"></i> Nº de pedido / referencia</dt><dd>Localiza un trámite citado por el investigador.</dd><dt><i class="bi bi-file-earmark-text text-success" aria-hidden="true"></i> Protocolo</dt><dd>Solo pedidos ligados a ese código.</dd><dt><i class="bi bi-person text-success" aria-hidden="true"></i> Solicitante</dt><dd>Filtra por quien cargó el formulario.</dd><dt><i class="bi bi-flag text-success" aria-hidden="true"></i> Estado</dt><dd>Pendiente, en preparación, entregado, cancelado, etc.</dd><dt><i class="bi bi-calendar2-week text-success" aria-hidden="true"></i> Fecha requerida</dt><dd>Priorice plazos de experimento declarados.</dd></dl>',
      },
      {
        id: 'table',
        cat: 'table',
        icon: 'table',
        h: 'Grilla de pedidos',
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-box-seam text-success" aria-hidden="true"></i> Ítem / catálogo</dt><dd>Nombre o código del reactivo según maestro de la sede.</dd><dt><i class="bi bi-sort-numeric-down text-success" aria-hidden="true"></i> Cantidad y unidad</dt><dd>Debe ser coherente con lo aprobado y con el almacén.</dd><dt><i class="bi bi-eye text-success" aria-hidden="true"></i> Ver detalle</dt><dd>Abre ficha con líneas, notas y adjuntos del formulario.</dd></dl>',
      },
      {
        id: 'row_actions',
        cat: 'row',
        icon: 'hand-index',
        h: 'Acciones en el detalle',
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-arrow-repeat text-success" aria-hidden="true"></i> Cambiar estado</dt><dd>Avanza el flujo según la taxonomía de su sede.</dd><dt><i class="bi bi-chat-left-text text-success" aria-hidden="true"></i> Nota al investigador</dt><dd>Visible en su vista de detalle.</dd><dt><i class="bi bi-x-octagon text-success" aria-hidden="true"></i> Rechazar / cancelar</dt><dd>Suele exigir motivo y confirmación en ventana emergente.</dd></dl>',
      },
      {
        id: 'prioridad',
        cat: 'content',
        icon: 'lightning-charge',
        h: 'Priorización y coherencia',
        html: '<ul class="mb-0"><li>Marque <strong>urgencias</strong> según la fecha de experimento declarada.</li><li>Resuelva primero pedidos que <strong>bloquean</strong> otros módulos (p. ej. ensayo que requiere el reactivo antes de animales).</li><li>Si su sede unificó reactivos en <strong>Insumos</strong>, use esa bandeja; aquí solo aplica cuando el menú muestra ambos.</li></ul>',
      },
    ],
  },
  admin__insumos: {
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'box-seam',
        h: 'Rol de la bandeja de insumos',
        html: '<p>Gestiona pedidos de <strong>consumibles y material de depósito</strong> que los investigadores envían por el sistema. Cada fila suele ser una solicitud; el detalle muestra líneas, notas y acciones permitidas. Mantener estados actualizados cierra el circuito de avisos hacia <strong>Mis formularios</strong>.</p>',
      },
      {
        id: 'toolbar',
        cat: 'toolbar',
        icon: 'wrench-adjustable',
        h: 'Barra superior',
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-arrow-clockwise text-success" aria-hidden="true"></i> Actualizar</dt><dd>Recarga pedidos y estados.</dd><dt><i class="bi bi-file-earmark-excel text-success" aria-hidden="true"></i> Exportar</dt><dd>Útil para depósito o compras cuando exista el botón.</dd><dt><i class="bi bi-funnel text-success" aria-hidden="true"></i> Filtros</dt><dd>Panel o campos superiores según diseño de la sede.</dd></dl>',
      },
      {
        id: 'operativa',
        cat: 'content',
        icon: 'clipboard-check',
        h: 'Operativa diaria',
        html: '<ul class="mb-0"><li>Confirme <strong>disponibilidad</strong> o plazo de compra antes de prometer fechas al investigador.</li><li>Si el ítem es <strong>substituible</strong>, deje el criterio en notas visibles al equipo.</li><li>Al <strong>entregar</strong>, actualice el estado para cerrar notificaciones.</li></ul>',
      },
      {
        id: 'lista_detalle',
        cat: 'table',
        ...
        html: '<p>La <strong>lista</strong> resume cada solicitud; al abrir una fila accede al <strong>detalle</strong> con líneas de ítem, notas y, si aplica, historial.</p><dl class="manual-glossary mb-0"><dt><i class="bi bi-search text-success" aria-hidden="true"></i> Búsqueda y filtros</dt><dd>Acoten volumen por fechas, estado o solicitante.</dd><dt><i class="bi bi-check2-square text-success" aria-hidden="true"></i> Entrega total</dt><dd>Antes de marcarla, confirme en detalle que las cantidades coinciden con el retiro físico.</dd></dl>',
      },
      {
        id: 'row_actions',
        cat: 'row',
        icon: 'hand-index',
        h: 'Acciones habituales en el pedido',
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-arrow-repeat text-success" aria-hidden="true"></i> Cambiar estado</dt><dd>Preparación, listo, entregado, etc., según su sede.</dd><dt><i class="bi bi-chat-left-text text-success" aria-hidden="true"></i> Notas</dt><dd>Comunicación con el investigador o nota interna si existe.</dd><dt><i class="bi bi-window-stack text-success" aria-hidden="true"></i> Confirmaciones</dt><dd>Cambios de cantidad o cierre suelen pedir ventana emergente.</dd></dl>',
      },
      {
        id: 'config',
        cat: 'links',
        ...
        html: '<p>Catálogos y listas permitidas suelen mantenerse en <strong>Configuración → Insumos experimentales</strong>. Si un pedido falla por ítem no catalogado, corrija primero el <strong>maestro</strong> antes de forzar el trámite.</p>',
      },
    ],
  },
  admin__reservas: {
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'calendar-week',
        h: 'Rol del módulo de reservas',
        html: '<p>Administra <strong>reservas de salas, equipos o franjas</strong> compartidas. La vista puede incluir calendario y listados; cada reserva enlaza con <strong>reglas internas</strong> (cancelación, duración máxima, quién puede reservar).</p>',
      },
      {
        id: 'vista',
        cat: 'filters',
        icon: 'calendar3',
        h: 'Vistas, fechas y conflictos',
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-calendar-range text-success" aria-hidden="true"></i> Rango de fechas</dt><dd>Acote el período antes de revisar solapamientos.</dd><dt><i class="bi bi-exclamation-triangle text-success" aria-hidden="true"></i> Superposiciones</dt><dd>Revise conflictos de horario antes de aprobar.</dd><dt><i class="bi bi-shield-check text-success" aria-hidden="true"></i> Aprobación</dt><dd>Algunas sedes exigen confirmación explícita del administrador para ciertos espacios.</dd></dl>',
      },
      {
        id: 'table',
        cat: 'table',
        icon: 'table',
        h: 'Lista y calendario',
        html: '<p>La <strong>grilla o vista calendario</strong> resume reservas con solicitante, recurso y estado. Un clic en un evento o fila abre el <strong>detalle</strong> para ajustar o anular según permisos.</p>',
      },
      {
        id: 'acciones',
        cat: 'row',
        ...
        html: '<ul class="mb-0"><li><strong>Documente</strong> el motivo de cambios impuestos desde administración.</li><li><strong>Comunique</strong> al investigador si la reserva se modifica desde back-office.</li><li>Las <strong>ventanas de confirmación</strong> al cancelar suelen ser definitivas: léalas antes de aceptar.</li></ul>',
      },
    ],
  },
  admin__alojamientos: {
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'house-heart',
        h: 'Rol de la grilla de alojamientos',
        html: '<p>Gestiona <strong>estadías de animales</strong> en bioterio: ubicación, cupos, responsables y cierre de períodos. Cada registro vincula <strong>protocolo</strong>, especie, cantidad y ventana de fechas. Use filtros para cuadrar con <strong>inventario físico</strong>.</p>',
      },
      {
        id: 'filters',
        cat: 'filters',
        icon: 'funnel',
        h: 'Filtros habituales',
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-file-earmark-text text-success" aria-hidden="true"></i> Protocolo</dt><dd>Acote por estudio autorizado.</dd><dt><i class="bi bi-calendar2-week text-success" aria-hidden="true"></i> Fechas</dt><dd>Período activo o histórico según necesidad.</dd><dt><i class="bi bi-geo-alt text-success" aria-hidden="true"></i> Ubicación / caja</dt><dd>Si su sede usa códigos o salas, filtre para auditoría.</dd></dl>',
      },
      {
        id: 'grilla',
        cat: 'table',
        icon: 'table',
        h: 'Grilla y detalle',
        html: '<p>La tabla lista alojamientos; al abrir una fila verá <strong>detalle</strong>, observaciones del bioterio y acciones permitidas. En pantallas estrechas puede requerirse desplazamiento horizontal.</p>',
      },
      {
        id: 'finalizar',
        cat: 'modals',
      ...
      },
      {
        ...
        cat: 'forms',
        icon: 'plus-circle',
        h: 'Alta de sujeto y ficha biológica',
        html: '<p>Con la trazabilidad física desplegada y el protocolo configurado (<strong>inicio</strong> y <strong>datos</strong>), puede <strong>añadir sujetos</strong> dentro de una caja. Tras confirmar el nombre, el árbol se actualiza y el aviso de éxito puede ofrecer abrir los <strong>datos biológicos</strong> (peso, sexo, cepa, subespecie, etc.).</p><p class="mb-0 small text-body-secondary">Al cerrar ese aviso, la tarjeta del sujeto recién creado suele <strong>desplazarse a la vista</strong> y mostrar un <strong>borde verde breve</strong> para localizarla entre varias filas.</p>',
      },
      {
        id: 'fichita_tras_alta',
        cat: 'forms',
        icon: 'clipboard-check',
        h: 'Completar la ficha tras crear el sujeto',
        html: '<p>El alta solo registra el sujeto en la caja; la <strong>ficha útil para auditoría y exportaciones</strong> combina <strong>datos biológicos</strong> (peso, sexo, cepa, etc.) y las <strong>variables de inicio</strong> que la sede definió por especie/protocolo en <strong>Configuración → Trazabilidad — inicio</strong>.</p><p class="mb-0">Abra la ficha desde el aviso de éxito o desde el sujeto en el árbol. Las mediciones posteriores van en <strong>Trazabilidad — datos</strong>. Un recorrido guiado más estricto puede definirse más adelante en producto; hoy el bioterio completa estos bloques según su protocolo interno.</p>',
      },
    ],
  },
  admin__estadisticas: {
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'bar-chart-line',
        h: 'Qué es el módulo de estadísticas',
        html: '<p>Concentra <strong>gráficos y totales</strong> sobre uso del bioterio o del sistema según contratación. Sirve para <strong>informes de gestión</strong> y picos de demanda; no sustituye el detalle de cada bandeja operativa.</p>',
      },
      {
        id: 'interpretacion',
        cat: 'dashboard',
        ...
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-calendar-range text-success" aria-hidden="true"></i> Rango de fechas</dt><dd>Amplios para tendencias; cortos para operativa del día.</dd><dt><i class="bi bi-database-check text-success" aria-hidden="true"></i> Calidad de datos</dt><dd>Los totales dependen de pedidos cerrados y alojamientos finalizados a tiempo.</dd><dt><i class="bi bi-link-45deg text-success" aria-hidden="true"></i> Profundizar</dt><dd>Si un indicador llama la atención, abra el módulo origen para casos concretos.</dd></dl>',
      },
      {
        id: 'toolbar',
        cat: 'toolbar',
        ...
        html: '<p>Si exporta (<strong>PDF</strong>, <strong>Excel</strong> u otro), <strong>anonimice</strong> cuando presente fuera de la institución y respete confidencialidad de proyectos. Los botones suelen aplicar al <strong>conjunto ya filtrado</strong> en pantalla.</p>',
      },
    ],
  },
  admin__configuracion__config: {
    ...
    blocks: [
      ...
      },
      {
        ...
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-check2-circle text-success" aria-hidden="true"></i> Guardar / Aceptar</dt><dd>En subpantallas confirma los cambios en el sistema; espere el mensaje de éxito antes de cerrar el navegador.</dd><dt><i class="bi bi-x-circle text-success" aria-hidden="true"></i> Cancelar</dt><dd>Descarta los cambios que aún no guardó en el formulario actual.</dd><dt><i class="bi bi-exclamation-triangle text-success" aria-hidden="true"></i> Aviso emergente</dt><dd>Cuadro pequeño centrado: suele indicar error de validación, permiso denegado o conflicto. Léalo con calma y corrija lo que pide antes de volver a intentar.</dd><dt><i class="bi bi-layout-text-window-reverse text-success" aria-hidden="true"></i> Ventana grande de edición</dt><dd>En algunas pantallas puede editar un registro en una ventana encima de la lista; al cerrar vuelve a la tabla de fondo.</dd></dl>',
      },
      {
        id: 'documentar',
        cat: 'content',
    ...
    blocks: [
      {
        ...
        html: '<p class="mb-0">Lista <strong>todos sus pedidos</strong> unificados (animales, reactivos, insumos). Cada fila es un envío; el estado lo actualiza el personal del bioterio o laboratorio.</p><dl class="manual-glossary mb-0"><dt><i class="bi bi-list-ul text-success" aria-hidden="true"></i> Lista unificada</dt><dd>Un solo lugar para seguir cualquier tipo de solicitud que haya enviado por el sistema.</dd><dt><i class="bi bi-file-earmark-text text-success" aria-hidden="true"></i> Cada fila</dt><dd>Representa un envío concreto; abra el detalle para ver líneas, notas del bioterio y adjuntos.</dd><dt><i class="bi bi-toggle-on text-success" aria-hidden="true"></i> Estado</dt><dd>Lo actualiza el personal del bioterio o laboratorio; si cambia, revise el detalle antes de volver a escribir.</dd></dl>',
      },
      {
        id: 'toolbar',
        cat: 'toolbar',
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'house-heart',
        h: 'Para qué sirve esta lista',
        html: '<p>Consulte <strong>sus estadías</strong> vinculadas a protocolos: planifique experimentos y renovaciones sin depender solo del teléfono. El detalle (costos, ubicación exacta) depende de lo que su sede muestre al investigador.</p>',
      },
      {
        id: 'consulta',
        cat: 'content',
        icon: 'calendar-check',
        h: 'Buenas prácticas de consulta',
        html: '<p>Si detecta <strong>discrepancias</strong> con el bioterio, abra un hilo en <strong>Mensajes</strong> citando el <strong>código de alojamiento</strong> visible en la grilla.</p>',
      },
      {
        id: 'lista_ficha',
        cat: 'table',
        ...
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-list text-success" aria-hidden="true"></i> Tabla</dt><dd>Lista períodos o cajas vinculados a su usuario o protocolo.</dd><dt><i class="bi bi-cursor text-success" aria-hidden="true"></i> Clic en fila</dt><dd>Abre detalle: fechas, especie, ubicación, observaciones del bioterio.</dd><dt><i class="bi bi-arrows-expand text-success" aria-hidden="true"></i> Scroll horizontal</dt><dd>En pantallas estrechas puede hacer falta para ver todas las columnas.</dd></dl>',
      },
    ],
  },
  panel__misreservas: {
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'calendar-week',
        h: 'Sus reservas en un vistazo',
        html: '<p>Aquí figuran las <strong>reservas a su nombre</strong>: salas, equipos u otros recursos según contratación. Revise horarios y estado (confirmada, pendiente, cancelada) según las reglas de su sede.</p>',
      },
      {
        id: 'gestion',
        cat: 'row',
        icon: 'sliders',
        h: 'Gestión y cancelación',
        html: '<ul class="mb-0"><li><strong>Cancele con antelación</strong> según reglas de su sede para liberar la franja.</li><li>Si necesita <strong>serie recurrente</strong>, compruebe si la interfaz lo permite o pídalo a administración.</li><li>Los <strong>cambios</strong> impuestos desde administración pueden notificarse por mensaje o correo según configuración.</li></ul>',
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'file-earmark-medical',
        h: 'Qué es Mis protocolos',
        html: '<p>Lista los <strong>protocolos en los que participa</strong>: vigencia, datos esenciales y, a menudo, selector de vista (propios, sede o red). Antes de un pedido nuevo, confirme aquí que el protocolo sigue <strong>vigente</strong> y autoriza lo que necesita.</p>',
      },
      {
        id: 'consulta',
        cat: 'detail',
        ...
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-calendar-range text-success" aria-hidden="true"></i> Vigencia</dt><dd>Fechas de inicio y fin de autorización.</dd><dt><i class="bi bi-heart-pulse text-success" aria-hidden="true"></i> Alcance</dt><dd>Especies y procedimientos permitidos.</dd><dt><i class="bi bi-people text-success" aria-hidden="true"></i> Roles</dt><dd>Titular, co-investigador u otros según asignación.</dd></dl>',
      },
      {
        id: 'solicitud',
        cat: 'links',
        ...
        html: '<p>Para <strong>ampliar vigencia</strong> o modificar alcance, el camino suele ser <strong>Solicitud de protocolo</strong> (enlace o menú que habilite la sede), no un pedido de animales suelto.</p><ul class="mb-0"><li>Mientras el trámite esté pendiente, puede haber <strong>restricciones</strong> a nuevos pedidos: consulte comité o bioterio.</li></ul>',
      },
      {
        id: 'vinculo',
        cat: 'comms',
        icon: 'share',
        h: 'Vínculo con RED',
        html: '<p>En instituciones <strong>multi-sede</strong>, el ámbito del protocolo lo define su administración. Los pedidos deben hacerse contra la sede que corresponda según reglas internas.</p>',
      },
    ],
  },
  admin__precios: {
    ...
    blocks: [
      {
        ...
        h: 'Rol de la pantalla de precios',
        html: '<p>Mantiene <strong>tarifas y listas</strong> que alimentan presupuestos y facturación del bioterio. Los cambios impactan informes y, si existen, vistas de costo para investigadores. Coordine con <strong>contabilidad o dirección</strong> antes de reestructurar precios.</p>',
      },
      {
        id: 'toolbar',
        cat: 'toolbar',
        icon: 'wrench-adjustable',
        h: 'Controles habituales en la grilla',
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-plus-lg text-success" aria-hidden="true"></i> Alta / duplicar lista</dt><dd>Según su sede: crear ítem o copiar estructura vigente.</dd><dt><i class="bi bi-pencil text-success" aria-hidden="true"></i> Edición</dt><dd>Modifica importes o vigencias; suele pedir guardar explícito.</dd><dt><i class="bi bi-search text-success" aria-hidden="true"></i> Búsqueda</dt><dd>Localiza servicio o código en listas largas.</dd></dl>',
      },
      {
        id: 'cambios',
        cat: 'content',
        icon: 'calendar-check',
        h: 'Cambios de precio y fechas efectivas',
        html: '<p><strong>Versionado</strong> y fechas efectivas: un cambio mal fechado puede desfasar facturas ya generadas. Coordine con <strong>Historial contable</strong> y reportes abiertos antes de aplicar rebajas o recargos masivos.</p>',
      },
    ],
  },
  admin__facturacion__index: {
    ...
    blocks: [
      ...
      },
      {
        ...
        cat: 'toolbar',
        icon: 'clock-history',
        h: 'Historial de saldo del titular',
        html: '<p>En <strong>departamento</strong>, <strong>protocolo</strong> e <strong>investigador</strong> puede abrir el historial de saldo desde los paneles de cobro. Por defecto el modal <strong>no copia automáticamente</strong> las fechas del informe principal, para no excluir movimientos recientes por un filtro demasiado estrecho.</p><p class="mb-0">Según la vista, bajo las tablas aparece un texto guía sobre el alcance del listado. Si ambas tablas quedan vacías y usted esperaba movimientos, revise registros en base de datos o consulte con soporte antes de reportar un fallo de interfaz.</p>',
      },
    ],
  },
  ...
  admin__facturacion__institucion: {
    ...
    blocks: [
      ...
      },
      {
        ...
        cat: 'toolbar',
        icon: 'diagram-3',
        h: 'Derivados y departamento de cobro',
        html: '<p>Las líneas con cobro <strong>derivado</strong> muestran la etiqueta correspondiente frente a las de cobro <strong>común</strong>. En la celda de departamento puede aparecer el área de origen y una segunda línea con el <strong>departamento donde se cobra el pedido</strong> (destino de la derivación), útil para conciliar entre sedes.</p><p class="mb-0">Las exportaciones en <strong>PDF</strong> y <strong>Excel</strong> incluyen ese dato en columna dedicada cuando aplica.</p>',
      },
      {
        id: 'pago',
        cat: 'modals',
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'journal-text',
        h: 'Qué es el historial contable',
        html: '<p>Documenta <strong>movimientos y ajustes</strong> vinculados a la facturación del bioterio dentro de GROBO: útil para auditoría y para entender correcciones en el tiempo. El detalle visible depende del <strong>rol</strong>.</p>',
      },
      {
        id: 'vs_historial_saldo_facturacion',
        cat: 'navigation',
        icon: 'question-circle',
        h: 'No confundir con el historial de saldo en facturación',
        html: '<p>Esta pantalla es el <strong>historial contable</strong> del bioterio (movimientos y ajustes para auditoría). Es distinta del <strong>historial de saldo del titular</strong> que se abre dentro de las vistas de <strong>facturación</strong> (departamento, protocolo o investigador): ese cuadro lista cargos y pagos del saldo según el alcance elegido.</p><p class="mb-0">Si busca movimientos de cobro del investigador y no aparecen aquí, use facturación y el botón de historial de saldo. Si esa tabla sale vacía pese a pagos recientes, revise alcance, filtros de fecha o datos en base; en el manual del <strong>Centro de facturación</strong> hay un apartado dedicado al historial de saldo.</p>',
      },
      {
        id: 'auditoria',
        cat: 'filters',
        ...
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-calendar-range text-success" aria-hidden="true"></i> Fecha</dt><dd>Acote el período a revisar.</dd><dt><i class="bi bi-person text-success" aria-hidden="true"></i> Usuario</dt><dd>Filtra quién registró el movimiento si el campo existe.</dd><dt><i class="bi bi-tag text-success" aria-hidden="true"></i> Tipo</dt><dd>Clasificación de ajuste o imputación según su sede.</dd></dl><p class="small text-muted mt-2 mb-0">No borre evidencias fuera de procedimientos aprobados; prefiera <strong>asientos reversivos</strong> si el sistema lo permite.</p>',
      },
    ],
  },
  panel__mensajes: {
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'chat-dots',
        h: 'Mensajes personales',
        html: '<p>Buzón para conversar <strong>1:1</strong> u otros hilos directos dentro de GROBO. Úselo para coordinar pedidos o documentación; no sustituye a la <strong>mensajería institucional</strong> masiva.</p>',
      },
      {
        id: 'hilo',
        cat: 'comms',
        ...
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-person-plus text-success" aria-hidden="true"></i> Destinatario</dt><dd>Elija usuario o buzón permitido por su sede.</dd><dt><i class="bi bi-card-heading text-success" aria-hidden="true"></i> Asunto</dt><dd>Claro y referenciado (p. ej. “Pedido A-1234 — entrega”).</dd><dt><i class="bi bi-reply text-success" aria-hidden="true"></i> Respuestas</dt><dd>Mantenga un solo hilo por tema para no perder contexto.</dd><dt><i class="bi bi-bell text-success" aria-hidden="true"></i> Correo</dt><dd>Compruebe en <strong>Mi perfil</strong> si recibe avisos por email.</dd></dl>',
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        html: '<p>Comunicación <strong>oficial</strong> de la sede: avisos que pueden ver muchas personas, consultas al buzón institucional o gestión que no es charla privada. Las conversaciones entre dos usuarios siguen en <strong>Mensajes</strong>.</p>',
      },
      {
        id: 'red',
        cat: 'comms',
        icon: 'share',
        h: 'Mensajes y RED',
        html: '<p>En <strong>redes multi-sede</strong>, puede usarse para anuncios entre sedes o comunicación oficial. Priorice textos breves y enlaces a <strong>noticias</strong> o documentos en repositorio institucional.</p>',
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'newspaper',
        h: 'Redacción de noticias (admin)',
        html: '<p>Desde aquí se crean y publican los avisos del <strong>portal de noticias</strong>. Puede definirse alcance (sede o red), fechas y borradores. No sustituye a la mensajería 1:1.</p>',
      },
      {
        id: 'publicar',
        cat: 'forms',
        ...
        html: '<ul class="mb-0"><li><strong>Fechas de vigencia</strong> claras para que avisos viejos no confundan.</li><li><strong>Tono institucional</strong> y datos de contacto ante dudas.</li><li>Revise <strong>ortografía</strong> y enlaces rotos antes de publicar.</li><li>Los <strong>modales</strong> de edición siguen el patrón cabecera/cuerpo/pie descrito en el tema de ventanas emergentes.</li></ul>',
      },
    ],
  },
  panel__noticias: {
    ...
    blocks: [
      {
        ...
        cat: 'navigation',
        icon: 'newspaper',
        h: 'Portal de noticias (lectura)',
        html: '<p>Tablón <strong>oficial</strong>: avisos, novedades y, si aplica, noticias compartidas con otras sedes. Para fallos del programa use <strong>Ayuda → Ticket/Contacto</strong> (si su rol lo tiene), no este tablón.</p>',
      },
      {
        id: 'lectura',
        cat: 'filters',
        icon: 'funnel',
        h: 'Cómo usarlo',
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-search text-success" aria-hidden="true"></i> Buscar</dt><dd>Filtra por texto cuando exista el campo.</dd><dt><i class="bi bi-geo-alt text-success" aria-hidden="true"></i> Alcance</dt><dd>Algunas sedes permiten ver solo local o también red.</dd><dt><i class="bi bi-cursor text-success" aria-hidden="true"></i> Abrir noticia</dt><dd>Muestra el cuerpo completo y adjuntos si los hay.</dd></dl><p class="small text-muted mt-2 mb-0">Consulte periódicamente; algunas convocatorias solo se anuncian aquí. Puede convivir con correo sin duplicación automática.</p>',
      },
    ],
  },
  panel__poe: {
    ...
    blocks: [
      ...
      },
      {
        ...
        cat: 'content',
        icon: 'card-heading',
        h: 'Abrir un documento',
        html: '<p>Pulse una tarjeta para ver el detalle en ventana emergente: texto, enlaces y accesos por URL si existen. Puede generarse un <strong>código QR</strong> para compartir el enlace del ítem cuando proceda.</p>',
      },
    ],
  },
  admin__comunicacion__poe: {
    ...
    blocks: [
      ...
      },
      {
        ...
        cat: 'forms',
        icon: 'ui-checks-grid',
        h: 'Contenido y enlaces',
        html: '<p>Revise el texto visible en el portal y las <strong>URLs https</strong> de soporte si aplica. Guarde y compruebe el orden; use la paginación en listas largas.</p>',
      },
    ],
  },
  'admin__comunicacion__portada-popup': {
    overview:
      'Portada y popup configuran dos piezas del portal de noticias: el texto de bienvenida en la pantalla principal y un aviso emergente opcional (interruptor, texto y vínculo opcional a una noticia publicada).\n\nTodo se guarda con un solo botón. Las URLs de adjuntos siguen siendo manuales hasta la fase de almacenamiento en nube.',
    summary:
      'Texto de portada del portal y popup para usuarios.',
    roles:
      'Administración de comunicación / noticias.',
    blocks: [
      {
        id: 'intro',
        cat: 'navigation',
        icon: 'columns-gap',
        h: 'Dos bloques en pantalla',
        html: '<p>A un lado, <strong>portada</strong> (título y cuerpo del tablero). Al otro, <strong>popup</strong> opcional con su interruptor de activación.</p>',
      },
      {
        id: 'guardar',
        cat: 'forms',
        icon: 'save',
        h: 'Guardar y validar',
        html: '<p>Use <strong>Guardar</strong> para persistir ambos bloques. Revise en el portal con un usuario sin privilegios que el texto y el popup se comporten como espera.</p>',
      },
    ],
  },
  panel__perfil: {
    ...
    summary:
      'Guía extensa: qué es la pantalla Mi perfil frente a la barra de preferencias; cada botón (voz, letra, tema claro/oscuro, idioma, atajos, menú superior/lateral) explicado por separado; cómo se guardan datos en servidor; y Gecko Search (píldora, teclado, búsqueda global por categorías y prefijos; la voz sigue en el botón del menú).',
    roles:
    ...
    blocks: [
      ...
      },
      {
        ...
        html: '<p class="mb-2">La <strong>barra de preferencias</strong> es una franja de controles que va <strong>junto al menú principal</strong>. Visualmente la reconocerá como una <strong>línea de iconos circulares</strong> (micrófono, letra, sol/luna, bandera, teclado, diseño) separada del resto de enlaces del menú por un <strong>borde o espacio</strong> sutil.</p><p class="mb-2"><strong>Menú superior (horizontal):</strong> los iconos suelen alinearse a la <strong>derecha</strong> de la barra superior, después de los accesos a módulos (Dashboard, Protocolos, etc.). El <strong>buscador Gecko</strong> (la píldora alargada con lupa) suele estar en la zona central o cercana; los botones redondos quedan agrupados al final de esa barra.</p><p class="mb-2"><strong>Menú lateral (vertical):</strong> los mismos controles se redistribuyen: a menudo en <strong>fila o bloque</strong> dentro del panel lateral, con botones algo <strong>más grandes</strong> para poder pulsarse con comodidad. La <strong>bandera de idioma</strong> abre el menú hacia arriba o hacia un lado según el espacio disponible.</p><p class="mb-2"><strong>Orden habitual de izquierda a derecha</strong> en la agrupación de iconos (puede variar levemente): (1) micrófono, (2) tamaño de letra, (3) tema claro/oscuro, (4) idioma con bandera, (5) ayuda de atajos de teclado, (6) cambio de diseño menú superior/lateral.</p><p class="mb-0 small text-muted"><strong>Pantallas pequeñas:</strong> en teléfonos muy estrechos algunos botones pueden ocultarse para ganar espacio. Si no ve el de atajos o el de diseño del menú, pruebe en tablet u ordenador; el buscador se puede abrir con <kbd>Ctrl</kbd>+<kbd>G</kbd>, <kbd>Ctrl</kbd>+<kbd>K</kbd> o <kbd>Alt</kbd>+<kbd>G</kbd> (en Mac también <kbd>⌘</kbd>+<kbd>G</kbd> / <kbd>⌘</kbd>+<kbd>K</kbd>).</p>',
      },
      {
        id: 'ctrl_microfono',
        cat: 'toolbar',
        ...
        html: '<p class="mb-2"><strong>Qué es este botón:</strong> enciende o apaga el <strong>asistente de voz</strong> que usa su navegador. El icono es un <strong>micrófono</strong>. No graba archivos para mandarlos por correo: solo convierte lo que usted dice en texto dentro del propio programa, cuando el navegador lo permite.</p><p class="mb-2"><strong>La primera vez:</strong> el navegador pedirá <strong>permiso para usar el micrófono</strong>. Acepte si quiere hablar con el sistema. Si lo bloquea, la voz no funcionará hasta que cambie el permiso del sitio en la configuración del navegador.</p><p class="mb-2"><strong>Cómo saber si está escuchando:</strong> cuando está <strong>activo</strong>, el botón suele verse más <strong>verde</strong> o resaltado. Cuando está <strong>apagado</strong>, se ve más neutro o gris. Enciéndalo solo cuando vaya a usar voz.</p><p class="mb-2"><strong>Palabra de activación y buscador:</strong> con el micrófono encendido, puede decir el nombre del asistente (por ejemplo «Gecko»); al reconocerlo, suele abrirse el <strong>cuadro de búsqueda</strong> para que siga hablando su pedido. Más detalle en el apartado «Gecko: voz e IA».</p><p class="mb-2"><strong>Navegadores:</strong> en <strong>Firefox</strong> la voz integrada a veces no está disponible y puede ver un aviso. Para voz suele ir mejor <strong>Chrome o Edge</strong>; si no, use teclado y ratón.</p><p class="mb-0 small text-muted"><strong>Atajo de teclado:</strong> <kbd>Alt</kbd>+<kbd>V</kbd> equivale a pulsar este botón en muchos equipos, cuando no está escribiendo en un campo que capture todas las teclas.</p>',
      },
      {
        ...
        html: '<p class="mb-2"><strong>Qué es:</strong> un botón que no abre menús: cada vez que lo pulsa, la aplicación pasa al <strong>siguiente tamaño de letra</strong> en un ciclo de tres pasos. Sirve para quien necesita leer más grande (accesibilidad) o más compacto (ver más datos en pantalla).</p><p class="mb-2"><strong>Los tres tamaños (orden del ciclo):</strong> <strong>chica</strong> → <strong>mediana</strong> → <strong>grande</strong> → vuelve a chica. El programa aplica ese tamaño a títulos, tablas, formularios y menús de forma <strong>uniforme</strong> en toda la sesión.</p><p class="mb-2"><strong>Qué notará usted:</strong> el texto sube o baja de tamaño en conjunto. <strong>No</strong> es lo mismo que el zoom del navegador (<kbd>Ctrl</kbd> + rueda del ratón): aquí solo cambia cómo GROBO muestra las letras.</p><p class="mb-2"><strong>Recuerdo entre sesiones:</strong> el tamaño elegido puede guardarse con su usuario para que al volver a entrar siga igual.</p><p class="mb-0 small text-muted"><strong>Consejo:</strong> si algo se ve cortado, pruebe el <strong>tema claro</strong> o haga la ventana más ancha; algunas tablas necesitan desplazarse horizontalmente.</p><p class="mb-0 small text-muted"><strong>Atajo:</strong> <kbd>Alt</kbd>+<kbd>Z</kbd> hace el mismo ciclo que este botón cuando el foco no está en un campo de texto.</p>',
      },
      {
        id: 'ctrl_tema',
        cat: 'toolbar',
        ...
        html: '<p class="mb-2"><strong>Qué es el “tema”:</strong> es el <strong>esquema de colores</strong> de toda la aplicación. El <strong>modo claro</strong> usa fondos claros y texto oscuro, parecido a un documento en papel. El <strong>modo oscuro</strong> usa fondos oscuros y texto claro, pensado para trabajar con poca luz y cansar menos la vista.</p><p class="mb-2"><strong>Qué hace el botón:</strong> al pulsarlo, el programa <strong>alterna</strong> entre claro y oscuro. Botones, menús, tablas y ventanas emergentes cambian de color de forma coherente.</p><p class="mb-2"><strong>El icono sol / luna:</strong> indica a qué modo puede pasar o cuál está activo según la versión; lo importante es que <strong>un solo botón</strong> controla el cambio, sin tener que buscar la opción dentro de Mi perfil.</p><p class="mb-2"><strong>Para quién es útil:</strong> quien trabaja muchas horas seguidas, pantallas muy brillantes o quien prefiere más contraste. Puede combinar tema oscuro con <strong>letra grande</strong>.</p><p class="mb-0 small text-muted">El tema puede guardarse en su cuenta para no tener que elegirlo en cada equipo.</p><p class="mb-0 small text-muted"><strong>Atajo:</strong> <kbd>Alt</kbd>+<kbd>T</kbd> alterna claro/oscuro cuando el foco no está en un campo de texto.</p>',
      },
      {
        id: 'ctrl_idioma',
        cat: 'toolbar',
        ...
        html: '<p class="mb-2"><strong>Qué es:</strong> un botón circular que muestra la <strong>bandera del idioma actual</strong> (España, EE. UU. o Brasil). Al pulsarlo se abre una <strong>lista de tres idiomas</strong> con bandera y nombre.</p><p class="mb-2"><strong>Las tres opciones:</strong> <strong>Español</strong>, <strong>English</strong> e <strong>Português</strong> (Brasil). Cambian todos los textos de menús, botones y mensajes del sistema. El asistente de voz también se alinea con el idioma elegido.</p><p class="mb-2"><strong>Qué ocurre al elegir:</strong> el programa <strong>guarda</strong> su idioma y <strong>recarga la página</strong>. Espere a que termine: hasta entonces puede ver mezcla de textos antiguos y nuevos.</p><p class="mb-2"><strong>Dónde se abre el menú:</strong> con menú arriba suele desplegarse hacia abajo; con menú lateral a veces hacia arriba para no salirse de la pantalla.</p><p class="mb-0 small text-muted">Si comparte equipo, el idioma queda ligado a su usuario y sesión, no solo a “modo incógnito” del navegador.</p>',
      },
      {
        id: 'ctrl_atajos',
        cat: 'toolbar',
        ...
        html: '<p class="mb-2"><strong>Qué es:</strong> abre la <strong>tabla de atajos</strong> en el idioma de la aplicación. Equivale a pulsar la tecla <kbd>?</kbd> cuando el foco <strong>no</strong> está en un cuadro de texto (si está escribiendo, la <kbd>?</kbd> puede insertarse en el campo). También puede usar <kbd>Alt</kbd>+<kbd>K</kbd> fuera de esos campos.</p><p class="mb-2"><strong>Buscador Gecko:</strong> <kbd>Ctrl</kbd>+<kbd>G</kbd> y <kbd>⌘</kbd>+<kbd>G</kbd> (Mac) abren o cierran el panel incluso con el cursor en un campo. <kbd>Ctrl</kbd>+<kbd>K</kbd> y <kbd>⌘</kbd>+<kbd>K</kbd> hacen lo mismo salvo cuando escribe en un campo y el panel está cerrado (así no interfiere con atajos de otros programas). <kbd>Alt</kbd>+<kbd>G</kbd> alterna el buscador cuando el foco no está en un campo que capture las teclas.</p><p class="mb-2"><strong><kbd>Esc</kbd>:</strong> cierra el buscador, menús desplegables o ventanas emergentes abiertas, según lo que esté delante.</p><p class="mb-2"><strong>Filtro de tabla:</strong> <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>F</kbd> (y <kbd>⌘</kbd>+<kbd>Shift</kbd>+<kbd>F</kbd> en Mac) lleva el foco al filtro principal del listado visible.</p><p class="mb-2"><strong><kbd>Alt</kbd> + letra (navegación):</strong> <kbd>D</kbd> inicio según rol; <kbd>C</kbd> capacitación; <kbd>M</kbd> mensajes; <kbd>N</kbd> formularios (nuevo pedido); <kbd>J</kbd> noticias; <kbd>S</kbd> soporte; <kbd>O</kbd> perfil; <kbd>R</kbd> reservas; <kbd>F</kbd> formularios; <kbd>B</kbd> facturación (admin sede); <kbd>H</kbd> ayuda de esta pantalla; <kbd>P</kbd> protocolos; <kbd>A</kbd> alojamientos; <kbd>Q</kbd> mis pedidos; <kbd>V</kbd> micrófono; <kbd>T</kbd> tema; <kbd>Z</kbd> tamaño de letra; <kbd>L</kbd> menú superior o lateral. La mayoría solo cuando el foco no está en un campo de texto. Puede <strong>desactivar estos atajos</strong> en la tabla de atajos (casilla al pie).</p><p class="mb-2"><strong>Cerrar sesión:</strong> <kbd>Alt</kbd>+<kbd>Q</kbd> y, en menos de medio segundo, <kbd>S</kbd> (secuencia <kbd>Q</kbd> seguida de <kbd>S</kbd>).</p><p class="mb-2"><strong>Administradores (sede):</strong> <kbd>Alt</kbd>+<kbd>X</kbd> y luego otra letra en la misma ventana de tiempo: <kbd>P</kbd> protocolos, <kbd>A</kbd> alojamientos, <kbd>B</kbd> facturación, <kbd>D</kbd> departamentos (en esa pantalla abre «Nuevo departamento»), <kbd>F</kbd> facturación por departamento, <kbd>U</kbd> usuarios, <kbd>E</kbd> estadísticas, <kbd>I</kbd> insumos, <kbd>K</kbd> reactivos, <kbd>J</kbd> animales, <kbd>V</kbd> reservas, <kbd>N</kbd> noticias.</p><p class="mb-2"><strong>Modales:</strong> con una ventana emergente o alerta abierta, <kbd>C</kbd> confirma o guarda si el foco no está en un campo de texto; los atajos <kbd>Alt</kbd>+letra no navegan mientras el modal esté abierto.</p><p class="mb-0 small text-muted">En móviles el botón del teclado puede ocultarse; la tabla que abre este botón es la referencia viva y coincide con lo implementado en la aplicación.</p>',
      },
      {
        id: 'ctrl_layout_menu',
        cat: 'toolbar',
        ...
        html: '<p class="mb-2"><strong>Qué es:</strong> alterna entre dos formas de ver el menú principal. En un modo el menú es una <strong>franja horizontal</strong> arriba. En el otro, los enlaces están en una <strong>columna a la izquierda</strong>.</p><p class="mb-2"><strong>Qué ocurre al pulsarlo:</strong> el programa <strong>guarda su preferencia</strong> y <strong>recarga la página</strong>. Tras recargar verá las mismas secciones pero con el menú arriba o al costado. Los iconos de preferencias (micrófono, tema, etc.) se reorganizan para encajar en el nuevo diseño.</p><p class="mb-2"><strong>Cuándo usar cada uno:</strong> el menú superior suele ir bien en pantallas anchas. El lateral suele gustar en portátiles o cuando quiere más espacio central para tablas.</p><p class="mb-0 small text-muted">En móviles este botón a veces no aparece; use una pantalla más ancha si necesita cambiar el diseño del menú.</p><p class="mb-0 small text-muted"><strong>Atajo:</strong> <kbd>Alt</kbd>+<kbd>L</kbd> hace el mismo cambio cuando el foco no está en un campo de texto.</p>',
      },
      {
        id: 'prefs_servidor',
        cat: 'toolbar',
        ...
        html: '<p class="mb-2"><strong>Por qué importa:</strong> si las preferencias quedaran solo en su navegador, al cambiar de ordenador o limpiar datos perdería tema, idioma, tamaño de letra, etc. GROBO intenta <strong>guardarlas en su cuenta</strong> cuando es posible.</p><p class="mb-2"><strong>Al cambiar un ajuste:</strong> el programa envía de forma segura lo necesario al servidor (tema, idioma, tamaño de letra, menú preferido, micrófono…). No todo se envía en cada clic: cada botón guarda lo que le corresponde.</p><p class="mb-2"><strong>Al iniciar sesión:</strong> si su tipo de usuario lo permite, se recuperan las preferencias guardadas y se aplican antes de que siga trabajando.</p><p class="mb-2"><strong>Casos especiales:</strong> algunos usuarios sin institución asignada pueden depender más de lo guardado solo en el navegador.</p><p class="mb-0 small text-muted">Si tiene dos pestañas abiertas y cambia algo en una, la otra puede mostrar valores viejos hasta que la recargue.</p>',
      },
      {
        id: 'gecko_buscar',
        cat: 'content',
        ...
        html: '<p class="mb-2"><strong>Qué es Gecko Search:</strong> el <strong>buscador central</strong> de GROBO: un solo cuadro para <strong>encontrar registros en todo el sistema</strong> (pedidos, protocolos, usuarios, alojamientos, insumos, departamentos, organismos…). Los resultados se muestran <strong>agrupados por categoría</strong>, cada uno con título y subtítulo legibles.</p><p class="mb-2"><strong>La barra alargada con lupa:</strong> suele mostrar un texto guía del estilo «Buscar en GROBO…». <strong>Al hacer clic</strong> se abre el panel grande. Con menú lateral la barra puede verse <strong>flotando</strong> arriba; con menú superior suele estar <strong>fija</strong> en la franja del menú.</p><p class="mb-2"><strong>Al abrir el panel:</strong> el resto de la página se <strong>oscurece</strong> y aparece un <strong>cuadro central</strong> con animación. Así se concentra la atención en la búsqueda sin perder la sesión detrás.</p><p class="mb-2"><strong>Dentro del cuadro:</strong> arriba está el <strong>campo donde escribe</strong>. Debajo aparecen los <strong>resultados por categoría</strong> mientras escribe (con un pequeño retardo para no saturar el servidor). Si no hay coincidencias, verá un mensaje claro y sugerencias de <strong>prefijos</strong> (por ejemplo <code>pedido 123</code>, <code>protocolo ABC</code>).</p><p class="mb-2"><strong>Atajos:</strong> <kbd>Ctrl</kbd>+<kbd>G</kbd> o <kbd>⌘</kbd>+<kbd>G</kbd> abren o cierran el panel desde casi cualquier pantalla, incluso con el foco en un campo de texto. <kbd>Ctrl</kbd>+<kbd>K</kbd> o <kbd>⌘</kbd>+<kbd>K</kbd> hacen lo mismo salvo cuando escribe en un campo y el panel está cerrado. <kbd>Alt</kbd>+<kbd>G</kbd> alterna el panel cuando el foco no está en un campo que capture las teclas.</p><p class="mb-2"><strong><kbd>Esc</kbd>:</strong> cierra el panel y vuelve a la pantalla de trabajo.</p><p class="mb-2"><strong>Micrófono en el panel:</strong> enciende o apaga el dictado enlazado al mismo sistema de voz que el botón redondo del menú.</p><p class="mb-2"><strong>Teclas <kbd>↓</kbd> y <kbd>↑</kbd>:</strong> con el cursor en el cuadro de búsqueda puede bajar y subir por la lista de resultados resaltados en verde.</p><p class="mb-2"><strong><kbd>Enter</kbd>:</strong> abre el <strong>primer resultado</strong> de la lista (o el que esté resaltado con las flechas). No envía la frase a ningún asistente de IA desde este panel.</p><p class="mb-0 small text-muted"><strong>Voz e IA:</strong> el micrófono de la barra del menú y las funciones de asistente por voz/IA (si su sede las tiene activas) son independientes del listado principal del buscador.</p>',
      },
      {
        id: 'gecko_voz_ia',
        cat: 'modals',
        ...
        html: '<p class="mb-2"><strong>En conjunto:</strong> primero el <strong>navegador</strong> convierte lo que usted dice en texto; luego el <strong>sistema</strong> interpreta ese texto y puede, según permisos, <strong>llevarle a otra pantalla</strong>, <strong>mostrar resultados de búsqueda</strong>, <strong>ayudar a rellenar un formulario</strong> o <strong>responder en voz alta</strong>.</p><p class="mb-2"><strong>1. Micrófono en la barra:</strong> actívelo hasta que quede claramente encendido. Suele seguir escuchando sin apagarse tras una sola palabra corta.</p><p class="mb-2"><strong>2. Palabra de activación:</strong> mientras escucha, el programa busca una forma del nombre del asistente (<strong>Gecko</strong>, <strong>Grobo</strong> y sonidos parecidos: geco, gueco, jeco, etc.). No hace falta pronunciación perfecta.</p><p class="mb-2"><strong>Palabras propias (entrenamiento ligero):</strong> en el buscador Gecko, el botón de <strong>ajuste de voz</strong> junto al micrófono permite añadir hasta quince términos cortos (p. ej. nombre de unidad); se guardan en su cuenta y el navegador puede usarlos para sesgar el reconocimiento en <strong>Chrome y Edge</strong>. En Firefox la lista solo sirve para detectar la activación, sin ese sesgo extra.</p><p class="mb-2"><strong>3. Ventana de datos abierta:</strong> si tiene un formulario grande encima de la pantalla, el buscador puede <strong>no abrirse solo</strong> para no tapar lo que está rellenando; use teclado y ratón con normalidad en ese caso.</p><p class="mb-2"><strong>4. Su pedido:</strong> después del nombre del asistente, diga lo que necesita. Verá el texto en el <strong>cuadro del buscador</strong> para comprobar que lo entendió.</p><p class="mb-2"><strong>5. Qué puede hacer la IA:</strong></p><ul class="small mb-3"><li><strong>Llevarle a otra sección</strong> del portal (por ejemplo usuarios o protocolos).</li><li><strong>Rellenar la lista de resultados</strong> de búsqueda con lo que corresponda.</li><li><strong>Ayudar en la página actual</strong> escribiendo en campos o pulsando acciones que el flujo permita.</li></ul><p class="mb-2"><strong>Voz de respuesta:</strong> a veces el sistema <strong>lee en voz alta</strong> la respuesta usando la voz del propio navegador, en el mismo idioma que tenga elegido en GROBO.</p><p class="mb-2"><strong>Si algo falla:</strong> leerá un mensaje de error en pantalla; si no hay conexión, la lista de resultados puede vaciarse. Vuelva a intentar cuando la red esté estable.</p><p class="mb-0 small text-muted"><strong>Privacidad:</strong> el audio lo trata su navegador; no use el micrófono donde la confidencialidad de su trabajo lo prohíba.</p>',
      },
      {
        id: 'form_perfil',
        cat: 'forms',
  ...
  panel__soporte: {
    ...
    blocks: [
      ...
      },
      {
        ...
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-card-heading text-success" aria-hidden="true"></i> Asunto</dt><dd>Corto y con módulo (ej. “Reservas — error al guardar”).</dd><dt><i class="bi bi-body-text text-success" aria-hidden="true"></i> Primer mensaje</dt><dd>Pasos para reproducir, captura si puede, navegador y rol.</dd><dt><i class="bi bi-1-circle text-success" aria-hidden="true"></i> Un tema por ticket</dt><dd>No mezcle incidencias distintas.</dd></dl>',
      },
      {
        id: 'turnos',
        cat: 'comms',
  ...
  panel__ventas: {
    ...
    blocks: [
      ...
      },
      {
        ...
        html: '<dl class="manual-glossary mb-0"><dt><i class="bi bi-text-paragraph text-success" aria-hidden="true"></i> Texto introductorio</dt><dd>Contexto y beneficios según oferta.</dd><dt><i class="bi bi-envelope-at text-success" aria-hidden="true"></i> Responderemos a</dt><dd>Muestra el correo de su perfil; ventas contestará ahí.</dd><dt><i class="bi bi-textarea-resize text-success" aria-hidden="true"></i> Mensaje</dt><dd>Campo donde escribe su consulta (mínimo 10 caracteres).</dd><dt><i class="bi bi-send text-success" aria-hidden="true"></i> Enviar</dt><dd>Envía el formulario al equipo comercial; el botón puede mostrar un momento de espera mientras se procesa.</dd></dl>',
      },
      {
        id: 'popup',
        cat: 'modals',
        ...
        html: '<p>Tras un envío correcto, suele mostrarse un <strong>mensaje de confirmación</strong> con el éxito, el correo de destino y que la respuesta llegará a su email de usuario.</p><ul class="mb-0"><li>Si falta correo en el perfil o el texto es muy corto, verá un aviso para corregirlo.</li><li>Si falla la conexión o el servidor, aparecerá un mensaje genérico; reintente más tarde.</li></ul>',
      },
    ],
  },
  panel__capacitacion: {
    ...
    blocks: [
      {
        ...
        html: '<ul class="mb-0"><li><strong>Lista a la izquierda:</strong> un botón por cada tema, alineado con lo que usted tiene en el menú (según su rol y lo contratado en la sede).</li><li><strong>Zona derecha:</strong> primero la explicación amplia de la sección, el resumen corto, a quién suele aplicar, y después los apartados que se abren y cierran.</li><li><strong>Títulos de categoría en verde:</strong> agrupan temas por tipo de pantalla (por ejemplo menú, filtros, tabla principal, formularios).</li><li><strong>Listas con iconos:</strong> cada ítem describe un control habitual (un botón, una zona); el dibujo exacto puede cambiar, pero la función es la que se indica.</li></ul><figure class="manual-cap-figure my-3 border rounded overflow-hidden"><img src="../../dist/img/capacitacion/panel-capacitacion-biblioteca-layout.svg" width="640" height="280" alt="Esquema: columna izquierda con lista de temas del manual y panel derecho con contenido y acordeón." class="img-fluid d-block w-100" style="max-height:280px;object-fit:contain" loading="lazy" decoding="async" /><figcaption class="small text-body-secondary px-3 py-2 border-top">Ilustración genérica sin datos reales; la apariencia puede variar según su sede y tema claro u oscuro.</figcaption></figure>',
      },
      {
        id: 'iconos',
        cat: 'content',
      ...
      },
      {
        ...
        html:
          '<p>La <strong>barra verde inferior</strong> enlaza al manual del tema actual y al tutorial interactivo de la <strong>pantalla</strong> que tiene delante (listado o vista principal).</p><ul class="mb-0"><li><strong>Ventana emergente abierta:</strong> aparece una franja de ayuda encima del fondo oscuro, un botón extra en la barra (solo en ese momento) y, en el menú <strong>Ayuda</strong>, el tutorial dedicado a <em>esa</em> ventana: arriba el título, en el centro los datos y campos, abajo los botones de acción. En el manual, el capítulo sobre <strong>ventanas emergentes</strong> explica con más detalle qué puede tocar y qué hace cada botón en los cobros habituales.</li><li><strong>Ocultar la barra:</strong> use «No mostrar más esta barra» en la propia barra o en la franja cuando hay una ventana encima; las dos se ocultan a la vez.</li><li><strong>Volver a mostrarla:</strong> interruptor en Capacitación o <strong>Ayuda → Mostrar barra inferior de ayuda</strong>.</li><li><strong>Tutoriales automáticos:</strong> la opción de no volver a mostrarlos al entrar en una pantalla aparece al <strong>final</strong> del recorrido, no al principio.</li><li><strong>¿Quiere repetir un tutorial?</strong> Ábralo cuando quiera desde la barra verde, desde <strong>Ayuda</strong> en el menú superior o desde Capacitación.</li></ul>',
      },
    ],
  },
  ...
  capacitacion__tema__modales: {
    overview:
      'Las ventanas emergentes concentran una tarea sin abandonar la pantalla de fondo: en facturación muestran la ficha de un pedido y permiten cobrar o ajustar importes. Los cuadros de aviso o confirmación pequeños sirven para advertencias, preguntas de sí/no o errores breves.\n\nEste tema describe qué es solo lectura, qué puede editar y qué hace cada botón en las ventanas habituales de cobro. Complementa al tutorial interactivo «Ventanas emergentes» del menú Ayuda.',
    summary:
    ...
    blocks: [
      ...
      },
      {
        id: 'pago_feedback',
        cat: 'modals',
        h: 'Si el pago falla o no actualiza el saldo',
        html: '<p>Al confirmar <strong>PAGAR</strong> o <strong>QUITAR</strong>, la interfaz muestra un indicador de carga y, al terminar, un mensaje de éxito o el texto que devuelve el servidor ante error (saldo insuficiente, pedido bloqueado, validaciones de exención o derivación, etc.).</p><p class="mb-0">Si el aviso indica éxito pero los importes no reflejan el cambio, recargue el informe o vuelva a abrir la fila: puede haber edición concurrente o datos desfasados en base de datos. Si el problema se repite, anote hora, número de pedido y usuario y escale a soporte con el mensaje mostrado.</p>',
      },
      {
        id: 'sweetalert',
        cat: 'modals',
        h: 'Avisos y confirmaciones pequeñas',
