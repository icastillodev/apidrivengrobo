  ...
  panel__perfil: {
    ...
    blocks: [
      ...
      },
      {
        ...
        html: '<p class="mb-2"><strong>Qué es:</strong> un botón con icono de <strong>teclado</strong> que abre la <strong>lista de atajos</strong> del programa: una “chuleta” para no memorizar combinaciones.</p><p class="mb-2"><strong><kbd>Ctrl</kbd> + <kbd>G</kbd> — Buscador Gecko:</strong> abre o cierra el panel grande de búsqueda. Suele funcionar incluso si el cursor está en un campo de texto. Úselo para buscar rápido sin ir con el ratón a la píldora.</p><p class="mb-2"><strong><kbd>Esc</kbd> — Cerrar:</strong> cierra el buscador si está abierto u otras ventanas que tenga delante, según el caso.</p><p class="mb-2"><strong><kbd>Alt</kbd> + <kbd>K</kbd> — Esta ayuda:</strong> equivale a pulsar el botón del teclado cuando está visible.</p><p class="mb-2"><strong><kbd>Alt</kbd> + <kbd>D</kbd> — Panel principal:</strong> lleva al tablero de inicio según su rol (administración o investigador).</p><p class="mb-2"><strong><kbd>Alt</kbd> + <kbd>V</kbd> — Micrófono:</strong> enciende o apaga el mismo control que el botón redondo del micrófono.</p><p class="mb-2"><strong>Otros atajos frecuentes con <kbd>Alt</kbd> + letra:</strong> por ejemplo <kbd>Alt</kbd>+<kbd>F</kbd> hacia <strong>formularios</strong>, <kbd>Alt</kbd>+<kbd>Q</kbd> a <strong>Mis formularios</strong>, <kbd>Alt</kbd>+<kbd>P</kbd> a <strong>Mis protocolos</strong>, <kbd>Alt</kbd>+<kbd>A</kbd> a <strong>Mis alojamientos</strong>. Los administradores pueden tener atajos extra hacia protocolos y alojamientos de gestión. La lista en pantalla es la referencia: si un texto no coincide con su menú, confíe en lo que ocurre al pulsar la tecla.</p><p class="mb-2"><strong><kbd>Alt</kbd>, luego <kbd>Q</kbd>, luego <kbd>S</kbd> — Cerrar sesión:</strong> cierra la sesión sin pasar por menús (secuencia de tres teclas).</p><p class="mb-0 small text-muted">En móviles el botón del teclado puede no mostrarse; los atajos siguen activos en ordenador cuando el programa los tiene habilitados.</p>',
      },
      {
        id: 'ctrl_layout_menu',
        cat: 'toolbar',
