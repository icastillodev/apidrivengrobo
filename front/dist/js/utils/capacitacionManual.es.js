  ...
  panel__perfil: {
    ...
    blocks: [
      ...
      },
      {
        ...
        html: '<p class="mb-2"><strong>Qué es:</strong> abre la <strong>tabla de atajos</strong> en el idioma de la aplicación. Equivale a pulsar la tecla <kbd>?</kbd> cuando el foco <strong>no</strong> está en un cuadro de texto (si está escribiendo, la <kbd>?</kbd> puede insertarse en el campo). También puede usar <kbd>Alt</kbd>+<kbd>K</kbd> fuera de esos campos.</p><p class="mb-2"><strong>Buscador Gecko:</strong> <kbd>Ctrl</kbd>+<kbd>G</kbd> y <kbd>⌘</kbd>+<kbd>G</kbd> (Mac) abren o cierran el panel incluso con el cursor en un campo. <kbd>Ctrl</kbd>+<kbd>K</kbd> y <kbd>⌘</kbd>+<kbd>K</kbd> hacen lo mismo salvo cuando escribe en un campo y el panel está cerrado (así no interfiere con atajos de otros programas). <kbd>Alt</kbd>+<kbd>G</kbd> alterna el buscador cuando el foco no está en un campo que capture las teclas.</p><p class="mb-2"><strong><kbd>Esc</kbd>:</strong> cierra el buscador, menús desplegables o ventanas emergentes abiertas, según lo que esté delante.</p><p class="mb-2"><strong><kbd>Alt</kbd> + letra (navegación):</strong> <kbd>D</kbd> inicio según rol; <kbd>C</kbd> capacitación; <kbd>M</kbd> mensajes; <kbd>N</kbd> noticias; <kbd>S</kbd> soporte; <kbd>O</kbd> perfil; <kbd>R</kbd> reservas; <kbd>F</kbd> formularios; <kbd>P</kbd> protocolos; <kbd>A</kbd> alojamientos; <kbd>Q</kbd> mis pedidos; <kbd>V</kbd> micrófono; <kbd>T</kbd> tema; <kbd>Z</kbd> tamaño de letra; <kbd>L</kbd> menú superior o lateral. La mayoría solo cuando el foco no está en un campo de texto.</p><p class="mb-2"><strong>Cerrar sesión:</strong> <kbd>Alt</kbd>+<kbd>Q</kbd> y, en menos de medio segundo, <kbd>S</kbd> (secuencia <kbd>Q</kbd> seguida de <kbd>S</kbd>).</p><p class="mb-2"><strong>Administradores (sede):</strong> <kbd>Alt</kbd>+<kbd>X</kbd> y luego otra letra en la misma ventana de tiempo: <kbd>P</kbd> protocolos, <kbd>A</kbd> alojamientos, <kbd>B</kbd> facturación, <kbd>U</kbd> usuarios, <kbd>E</kbd> estadísticas, <kbd>I</kbd> insumos, <kbd>K</kbd> reactivos, <kbd>J</kbd> animales, <kbd>V</kbd> reservas, <kbd>N</kbd> noticias.</p><p class="mb-0 small text-muted">En móviles el botón del teclado puede ocultarse; la tabla que abre este botón es la referencia viva y coincide con lo implementado en la aplicación.</p>',
      },
      {
        id: 'ctrl_layout_menu',
        cat: 'toolbar',
      ...
      },
      {
        ...
        html: '<p class="mb-2"><strong>Qué es Gecko Search:</strong> el <strong>buscador central</strong> de GROBO: un solo cuadro para buscar en el sistema y, si su sede lo tiene activo, pedir ayuda a la <strong>IA</strong> con frases completas (véase también el apartado de voz e IA).</p><p class="mb-2"><strong>La barra alargada con lupa:</strong> suele mostrar un texto guía del estilo «Escribe un comando o di Gecko…». <strong>Al hacer clic</strong> se abre el panel grande. Con menú lateral la barra puede verse <strong>flotando</strong> arriba; con menú superior suele estar <strong>fija</strong> en la franja del menú.</p><p class="mb-2"><strong>Al abrir el panel:</strong> el resto de la página se <strong>oscurece</strong> y aparece un <strong>cuadro central</strong> con animación. Así se concentra la atención en la búsqueda sin perder la sesión detrás.</p><p class="mb-2"><strong>Dentro del cuadro:</strong> arriba está el <strong>campo donde escribe</strong> y un botón de <strong>micrófono</strong> para dictar sin volver a la barra. Debajo aparecen los <strong>resultados</strong> mientras escribe. Si no hay coincidencias, verá un mensaje claro con icono de lupa.</p><p class="mb-2"><strong>Atajos:</strong> <kbd>Ctrl</kbd>+<kbd>G</kbd> o <kbd>⌘</kbd>+<kbd>G</kbd> abren o cierran el panel desde casi cualquier pantalla, incluso con el foco en un campo de texto. <kbd>Ctrl</kbd>+<kbd>K</kbd> o <kbd>⌘</kbd>+<kbd>K</kbd> hacen lo mismo salvo cuando escribe en un campo y el panel está cerrado. <kbd>Alt</kbd>+<kbd>G</kbd> alterna el panel cuando el foco no está en un campo que capture las teclas.</p><p class="mb-2"><strong><kbd>Esc</kbd>:</strong> cierra el panel y vuelve a la pantalla de trabajo.</p><p class="mb-2"><strong>Micrófono en el panel:</strong> enciende o apaga el dictado enlazado al mismo sistema de voz que el botón redondo del menú.</p><p class="mb-2"><strong>Teclas <kbd>↓</kbd> y <kbd>↑</kbd>:</strong> con el cursor en el cuadro de búsqueda puede bajar y subir por la lista de resultados resaltados en verde.</p><p class="mb-2"><strong><kbd>Enter</kbd>:</strong> si tiene un resultado resaltado, confirma como si hiciera clic. Si no hay fila seleccionado pero <strong>sí</strong> hay texto escrito, suele enviar la frase a la <strong>IA</strong> (igual que al terminar de hablar): verá un mensaje del estilo «Consultando a GROBO IA…» mientras espera respuesta.</p><p class="mb-0 small text-muted"><strong>Respuestas de IA:</strong> el texto puede aparecer en el propio panel de búsqueda o en un bloque dedicado debajo, según la versión.</p>',
      },
      {
        id: 'gecko_voz_ia',
        cat: 'modals',
